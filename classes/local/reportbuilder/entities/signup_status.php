 ...
 */
class signup_status extends base {

    protected function get_default_entity_title(): lang_string {
        return new lang_string('signupstatus', 'mod_facetoface');
    }

    protected function get_default_tables(): array {
        return ['facetoface_signups_status'];
    }
    ...
    protected function initialise_columns(): self {
        $table = $this->get_table_alias('facetoface_signups_status');

        $column = (new column('statuscode', new lang_string('status', 'mod_facetoface'), $this->get_entity_name()))
            ->add_field("{$table}.statuscode")
